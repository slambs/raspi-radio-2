...
const STATIONS = [
    ...
    {
        name: 'Velvet 96.8',
        src: 'https://metromedia.live24.gr/velvet968thess?ver=60799',
    },
    ...
    {
        name: 'Transistor 100.3',
        src: 'http://netradio.live24.gr/tranzistor1003thess',
    },
];
            ...
            <div className="radioComponent">
                <ul className="d-flex radioStyle">
                    {STATIONS.map((radioStations, i) => {
                        const className =
                            'd-flex list-group-item  list-group-item-secondary';
                        return (
                            <li
                                id={radioStations.name}
                                key={i}
                                className={className}
                                onClick={this.handleRadio.bind(
                                    this,
                                    radioStations
                                )}
                            >
